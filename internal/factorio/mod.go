...
// with nothing to say so. A mod whose bindings come from a 2.1.14 description
...
// GA (2.0.x) and the machine that runs the in-game gates has 2.1.14 installed,
...
// majorMinor takes the "2.1" series out of a "2.1.14" build id. A string with
