...
//	                   2.0.77, 2.1.12 and 2.1.14 all report 6, so one generator
//	                   serves every data set we support.
...
// project quotes -- 3774 across 156 classes at the 2.1.14 pin -- and operators
...
// stable. 2.1.x is available to anyone who wants it -- `api = "2.1.14"` in
// fklua.toml, or `--api=2.1.14` -- and both descriptions are committed
// precisely so that choice needs neither the game nor the network.
//
...
//     library on a 2.1.14 engine with no rebuild and no repin.
//
