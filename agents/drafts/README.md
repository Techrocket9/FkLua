...
|---|---|
| `bench.py` + `harness.lua` | 4a and 4b: the real `fk_abi.lua` and the real emitted `memio`, with a prototype of each shape beside the per-call path. `RESULTS.txt` is its output. |
