...
| **A jump spans at most 131,071 VM instructions** | `MAXARG_sBx`. Past it the parser refuses the whole chunk with `control structure too long`, pointing into generated Lua and naming nothing in the guest. **Verified**: 131,071 loads, 131,072 is rejected. See "A jump is 18 bits" below. |
